...
class RetrievalService:
    ...
    def load_artifact(self) -> None:
        ...
        try:
            ...
            if expected_count > 0:
                req_fields = {"issue_id", "title", "target_label", "created_at", "url"}
    ...
    def search(
        ...
        # Deterministic sorting: similarity desc, then issue_id asc
        results.sort(key=lambda x: (-x["similarity_score"], x["issue_id"]))
